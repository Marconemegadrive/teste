...
namespace Exo.WebApi.Contexts
{
    ...
    optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
             // Essa string de conexão depende da SUA máquina.
               optionsBuilder.UseSqlServer("ID=sa;Password=M@ys@m@nu0516;Server=localhost;Database=ExoApi;Trusted_Connection=False;");
    ...
    // + Trusted_Connection=False;
        ...
        public Projeto NomeDoProjeto { get; internal set; }
    }
}